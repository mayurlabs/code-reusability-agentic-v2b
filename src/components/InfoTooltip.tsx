...
export const TIP: Record<string, string> = {
  ...
  'near-duplicate': 'Code very similar to another implementation but with local differences like naming, branching, or object-specific adjustments.',
  ...
  'retire': 'This variant may be removed later, but only after verifying all dependent callers have been migrated to the preferred version.',
